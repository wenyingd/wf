...
var (
	guidCalloutBuiltInReserved1                       = windows.GUID{0x779719a4, 0xe695, 0x47b6, [8]byte{0xa1, 0x99, 0x79, 0x99, 0xfe, 0xc9, 0x16, 0x3b}}
	guidCalloutBuiltInReserved2                       = windows.GUID{0xef9661b6, 0x7c5e, 0x48fd, [8]byte{0xa1, 0x30, 0x96, 0x67, 0x8c, 0xea, 0xcc, 0x41}}
	guidCalloutBuiltInReserved3                       = windows.GUID{0x18729c7a, 0x2f62, 0x4be0, [8]byte{0x96, 0x6f, 0x97, 0x4b, 0x21, 0xb8, 0x6d, 0xf1}}
	guidCalloutBuiltInReserved4                       = windows.GUID{0x6c3fb801, 0xdaff, 0x40e9, [8]byte{0x91, 0xe6, 0xf7, 0xff, 0x7e, 0x52, 0xf7, 0xd9}}
	...
	guidCalloutOutboundNetworkConnectionPolicyLayerV4 = windows.GUID{0x103090d4, 0x8e28, 0x4fd6, [8]byte{0x98, 0x94, 0xd1, 0xd6, 0x7d, 0x6b, 0x10, 0xc9}}
	guidCalloutOutboundNetworkConnectionPolicyLayerV6 = windows.GUID{0x4ed3446d, 0x8dc7, 0x459b, [8]byte{0xb0, 0x9f, 0xc1, 0xcb, 0x7a, 0x8f, 0x86, 0x89}}
...
var (
	...
	LayerOutboundNetworkConnectionPolicyV4 = LayerID{0x037f317a, 0xd696, 0x494a, [8]byte{0xbb, 0xa5, 0xbf, 0xfc, 0x26, 0x5e, 0x60, 0x52}}
	LayerOutboundNetworkConnectionPolicyV6 = LayerID{0x22a4fdb1, 0x6d7e, 0x48ae, [8]byte{0xae, 0x77, 0x37, 0x42, 0x52, 0x5c, 0x31, 0x19}}
...
var (
	...
	guidProviderMpssvcAppIsolation        = windows.GUID{0x3cc2631f, 0x2d5d, 0x43a0, [8]byte{0xb1, 0x74, 0x61, 0x48, 0x37, 0xd8, 0x63, 0xa1}}
	guidProviderMpssvcEdp                 = windows.GUID{0xa90296f7, 0x46b8, 0x4457, [8]byte{0x8f, 0x84, 0xb0, 0x5e, 0x05, 0xd3, 0xc6, 0x22}}
	guidProviderMpssvcTenantRestrictions  = windows.GUID{0xd0718ff9, 0x44da, 0x4f50, [8]byte{0x9d, 0xc2, 0xc9, 0x63, 0xa4, 0x24, 0x76, 0x13}}
	guidProviderMpssvcWf                  = windows.GUID{0xdecc16ca, 0x3f33, 0x4346, [8]byte{0xbe, 0x1e, 0x8f, 0xb4, 0xae, 0x0f, 0x3d, 0x62}}
	guidProviderMpssvcWsh                 = windows.GUID{0x4b153735, 0x1049, 0x4480, [8]byte{0xaa, 0xb4, 0xd1, 0xb9, 0xbd, 0xc0, 0x37, 0x10}}
...
var (
	guidSublayerIPSecDosp                  = SublayerID{0xe076d572, 0x5d3d, 0x48ef, [8]byte{0x80, 0x2b, 0x90, 0x9e, 0xdd, 0xb0, 0x98, 0xbd}}
	guidSublayerIPSecForwardOutboundTunnel = SublayerID{0xa5082e73, 0x8f71, 0x4559, [8]byte{0x8a, 0x9a, 0x10, 0x1c, 0xea, 0x04, 0xef, 0x87}}
	guidSublayerIPSecSecurityRealm         = SublayerID{0x37a57701, 0x5884, 0x4964, [8]byte{0x92, 0xb8, 0x3e, 0x70, 0x46, 0x88, 0xb0, 0xad}}
	guidSublayerIPSecTunnel                = SublayerID{0x83f299ed, 0x9ff4, 0x4967, [8]byte{0xaf, 0xf4, 0xc3, 0x09, 0xf4, 0xda, 0xb8, 0x27}}
	guidSublayerInspection                 = SublayerID{0x877519e1, 0xe6a9, 0x41a5, [8]byte{0x81, 0xb4, 0x8c, 0x4f, 0x11, 0x8e, 0x4a, 0x60}}
	guidSublayerLIPS                       = SublayerID{0x1b75c0ce, 0xff60, 0x4711, [8]byte{0xa7, 0x0f, 0xb4, 0x95, 0x8c, 0xc3, 0xb2, 0xd0}}
	guidSublayerMpssvcAppIsolation         = SublayerID{0xffe221c3, 0x92a8, 0x4564, [8]byte{0xa5, 0x9f, 0xda, 0xfb, 0x70, 0x75, 0x60, 0x20}}
	guidSublayerMpssvcEdp                  = SublayerID{0x09a47e38, 0xfa97, 0x471b, [8]byte{0xb1, 0x23, 0x18, 0xbc, 0xd7, 0xe6, 0x50, 0x71}}
	guidSublayerMpssvcQuarantine           = SublayerID{0xb3cdd441, 0xaf90, 0x41ba, [8]byte{0xa7, 0x45, 0x7c, 0x60, 0x08, 0xff, 0x23, 0x02}}
	guidSublayerMpssvcTenantRestrictions   = SublayerID{0x1ec6c7e1, 0xfdd9, 0x478a, [8]byte{0xb5, 0x5f, 0xff, 0x8b, 0xa1, 0xd2, 0xc1, 0x7d}}
	guidSublayerMpssvcWf                   = SublayerID{0xb3cdd441, 0xaf90, 0x41ba, [8]byte{0xa7, 0x45, 0x7c, 0x60, 0x08, 0xff, 0x23, 0x01}}
	guidSublayerMpssvcWsh                  = SublayerID{0xb3cdd441, 0xaf90, 0x41ba, [8]byte{0xa7, 0x45, 0x7c, 0x60, 0x08, 0xff, 0x23, 0x00}}
	guidSublayerRPCAudit                   = SublayerID{0x758c84f4, 0xfb48, 0x4de9, [8]byte{0x9a, 0xeb, 0x3e, 0xd9, 0x55, 0x1a, 0xb1, 0xfd}}
	guidSublayerSecureSocket               = SublayerID{0x15a66e17, 0x3f3c, 0x4f7b, [8]byte{0xaa, 0x6c, 0x81, 0x2a, 0xa6, 0x13, 0xdd, 0x82}}
	guidSublayerTCPChimneyOffload          = SublayerID{0x337608b9, 0xb7d5, 0x4d5f, [8]byte{0x82, 0xf9, 0x36, 0x18, 0x61, 0x8b, 0xc0, 0x58}}
	guidSublayerTCPTemplates               = SublayerID{0x24421dcf, 0x0ac5, 0x4caa, [8]byte{0x9e, 0x14, 0x50, 0xf6, 0xe3, 0x63, 0x6a, 0xf0}}
	guidSublayerTeredo                     = SublayerID{0xba69dc66, 0x5176, 0x4979, [8]byte{0x9c, 0x89, 0x26, 0xa7, 0xb4, 0x6a, 0x83, 0x27}}
	guidSublayerUniversal                  = SublayerID{0xeebecc03, 0xced4, 0x4380, [8]byte{0x81, 0x9a, 0x27, 0x34, 0x39, 0x7b, 0x2b, 0x74}}
)

var guidNames = map[windows.GUID]string{
	guidCalloutBuiltInReserved1:                          "CALLOUT_BUILT_IN_RESERVED_1",
	guidCalloutBuiltInReserved2:                          "CALLOUT_BUILT_IN_RESERVED_2",
	guidCalloutBuiltInReserved3:                          "CALLOUT_BUILT_IN_RESERVED_3",
	guidCalloutBuiltInReserved4:                          "CALLOUT_BUILT_IN_RESERVED_4",
	...
	guidCalloutOutboundNetworkConnectionPolicyLayerV4:    "CALLOUT_OUTBOUND_NETWORK_CONNECTION_POLICY_LAYER_V4",
	guidCalloutOutboundNetworkConnectionPolicyLayerV6:    "CALLOUT_OUTBOUND_NETWORK_CONNECTION_POLICY_LAYER_V6",
	...
	windows.GUID(LayerOutboundNetworkConnectionPolicyV4): "OUTBOUND_NETWORK_CONNECTION_POLICY_V4",
	windows.GUID(LayerOutboundNetworkConnectionPolicyV6): "OUTBOUND_NETWORK_CONNECTION_POLICY_V6",
	...
	guidProviderMpssvcAppIsolation:                       "PROVIDER_MPSSVC_APP_ISOLATION",
	guidProviderMpssvcEdp:                                "PROVIDER_MPSSVC_EDP",
	guidProviderMpssvcTenantRestrictions:                 "PROVIDER_MPSSVC_TENANT_RESTRICTIONS",
	guidProviderMpssvcWf:                                 "PROVIDER_MPSSVC_WF",
	guidProviderMpssvcWsh:                                "PROVIDER_MPSSVC_WSH",
	guidProviderTCPChimneyOffload:                        "PROVIDER_TCP_CHIMNEY_OFFLOAD",
	guidProviderTCPTemplates:                             "PROVIDER_TCP_TEMPLATES",
	windows.GUID(guidSublayerInspection):                 "SUBLAYER_INSPECTION",
	windows.GUID(guidSublayerIPSecDosp):                  "SUBLAYER_IPSEC_DOSP",
	windows.GUID(guidSublayerIPSecForwardOutboundTunnel): "SUBLAYER_IPSEC_FORWARD_OUTBOUND_TUNNEL",
	windows.GUID(guidSublayerIPSecSecurityRealm):         "SUBLAYER_IPSEC_SECURITY_REALM",
	windows.GUID(guidSublayerIPSecTunnel):                "SUBLAYER_IPSEC_TUNNEL",
	windows.GUID(guidSublayerLIPS):                       "SUBLAYER_LIPS",
	windows.GUID(guidSublayerMpssvcAppIsolation):         "SUBLAYER_MPSSVC_APP_ISOLATION",
	windows.GUID(guidSublayerMpssvcEdp):                  "SUBLAYER_MPSSVC_EDP",
	windows.GUID(guidSublayerMpssvcQuarantine):           "SUBLAYER_MPSSVC_QUARANTINE",
	windows.GUID(guidSublayerMpssvcTenantRestrictions):   "SUBLAYER_MPSSVC_TENANT_RESTRICTIONS",
	windows.GUID(guidSublayerMpssvcWf):                   "SUBLAYER_MPSSVC_WF",
	windows.GUID(guidSublayerMpssvcWsh):                  "SUBLAYER_MPSSVC_WSH",
	windows.GUID(guidSublayerRPCAudit):                   "SUBLAYER_RPC_AUDIT",
	windows.GUID(guidSublayerSecureSocket):               "SUBLAYER_SECURE_SOCKET",
	windows.GUID(guidSublayerTCPChimneyOffload):          "SUBLAYER_TCP_CHIMNEY_OFFLOAD",
	windows.GUID(guidSublayerTCPTemplates):               "SUBLAYER_TCP_TEMPLATES",
	windows.GUID(guidSublayerTeredo):                     "SUBLAYER_TEREDO",
	windows.GUID(guidSublayerUniversal):                  "SUBLAYER_UNIVERSAL",
}
